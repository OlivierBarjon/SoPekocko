...
module.exports = (req, res, next) => {
    try { // étant donné que de nombreux problèmes peuvent se produire on utilise un bloc try…catch
        ...
        const decodedToken = jwt.verify(token, 'xvdfetdhdkoroelddjkkz');// on décode le token avec la fonction verify de jwt (on vérifie le token par rapport à notre clé secrète)
